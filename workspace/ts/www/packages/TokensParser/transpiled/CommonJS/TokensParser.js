...
class TokensParser {
        ...
        tokens: for (tokensSetId = 0; tokensSetId < severalTokensSets_AsUint8Array.length; tokensSetId++) {
            ...
            lookupRanges: for (let lookupRange of inBitsbufRanges) {
                ...
                for (i = 0; i < maxIterationsNumber; i++) {
                    ...
                    let pos = this.getRangeOfTokensSetMatch(inBitsbuf, tokensSet_AsUint8Array, tokenMatchedRange, start, lookupRange[1]);
                    if (pos === false) {
     ...
     */
    firstIndexOf(inBitsBuf, inToken_Uint8Array, inStartPos, inEndPos) {
...
exports.TokensParser = TokensParser;
//# sourceMappingURL=TokensParser.js.map