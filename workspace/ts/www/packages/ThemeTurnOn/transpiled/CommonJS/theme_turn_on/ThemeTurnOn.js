...
exports.ThemeTurnOn = void 0;
const ThemeTurnOnConstants_js_1 = require("../constants/ThemeTurnOnConstants.js");
class ThemeTurnOn {
    constructor() {
        this._themeTurnOnConstants = new ThemeTurnOnConstants_js_1.ThemeTurnOnConstants();
    ...
    addThemeButtonsEventHandlers(inButtonsQuerySelectors) {
        for (let querySelector of inButtonsQuerySelectors) {
            ...
            buttonNodes.forEach((btn) => {
                btn.addEventListener("click", this.btnThemeClickEventHandler.bind(this));
            });
        }
    }
}
exports.ThemeTurnOn = ThemeTurnOn;
//# sourceMappingURL=ThemeTurnOn.js.map