...
export class CharcodeSymbolConstants extends SymbolConstants {
  ...
  constructor() {
    ...
    this.#CHARCODE__SYMBOL__NUMBER__0_ZERO             = this.getCharcodeSymbol( this.getSymbolNumber0() );
    this.#CHARCODE__SYMBOL__NUMBER__1_ONE              = this.getCharcodeSymbol( this.getSymbolNumber1() );
    this.#CHARCODE__SYMBOL__NUMBER__2_TWO              = this.getCharcodeSymbol( this.getSymbolNumber2() );
    this.#CHARCODE__SYMBOL__NUMBER__3_THREE            = this.getCharcodeSymbol( this.getSymbolNumber3() );
    this.#CHARCODE__SYMBOL__NUMBER__4_FOUR             = this.getCharcodeSymbol( this.getSymbolNumber4() );
    this.#CHARCODE__SYMBOL__NUMBER__5_FIVE             = this.getCharcodeSymbol( this.getSymbolNumber5() );
    this.#CHARCODE__SYMBOL__NUMBER__6_SIX              = this.getCharcodeSymbol( this.getSymbolNumber6() );
    this.#CHARCODE__SYMBOL__NUMBER__7_SEVEN            = this.getCharcodeSymbol( this.getSymbolNumber7() );
    this.#CHARCODE__SYMBOL__NUMBER__8_EIGHT            = this.getCharcodeSymbol( this.getSymbolNumber8() );
    this.#CHARCODE__SYMBOL__NUMBER__9_NINE             = this.getCharcodeSymbol( this.getSymbolNumber9() );

  }



  public getCharcode_QuoteDouble():        number { return this.#CHARCODE__SYMBOL__QUOTE_DOUBLE; }
  public getCharcode_QuoteSingle():        number { return this.#CHARCODE__SYMBOL__QUOTE_SINGLE; }
  public getCharcode_QuoteAlt():           number { return this.#CHARCODE__SYMBOL__QUOTE_ALT; }



  public getCharcode_BraceRoundOpen():     number { return this.#CHARCODE__SYMBOL__BRACE_ROUND_OPEN; }
  public getCharcode_BraceRoundClose():    number { return this.#CHARCODE__SYMBOL__BRACE_ROUND_CLOSE; }

  public getCharcode_BraceTriangleOpen():  number { return this.#CHARCODE__SYMBOL__BRACE_TRIANGLE_OPEN; }
  public getCharcode_BraceTriangleClose(): number { return this.#CHARCODE__SYMBOL__BRACE_TRIANGLE_CLOSE; }

  public getCharcode_BraceSquareOpen():    number { return this.#CHARCODE__SYMBOL__BRACE_SQUARE_OPEN; }
  public getCharcode_BraceSquareClose():   number { return this.#CHARCODE__SYMBOL__BRACE_SQUARE_CLOSE; }

  public getCharcode_BraceFigureOpen():    number { return this.#CHARCODE__SYMBOL__BRACE_FIGURE_OPEN; }
  public getCharcode_BraceFigureClose():   number { return this.#CHARCODE__SYMBOL__BRACE_FIGURE_CLOSE; }



  public getCharcode_Colon():              number { return this.#CHARCODE__SYMBOL__COLON; }
  public getCharcode_Semicolon():          number { return this.#CHARCODE__SYMBOL__SEMICOLON; }

  public getCharcode_Point():              number { return this.#CHARCODE__SYMBOL__POINT; }
  public getCharcode_Comma():              number { return this.#CHARCODE__SYMBOL__COMMA; }

  public getCharcode_Dash():               number { return this.#CHARCODE__SYMBOL__DASH; }
  public getCharcode_Underscore():         number { return this.#CHARCODE__SYMBOL__UNDERSORE; }

  public getCharcode_Slash():              number { return this.#CHARCODE__SYMBOL__SLASH; }
  public getCharcode_SlashUpwards():       number { return this.#CHARCODE__SYMBOL__SLASH_UPWARDS; }
  ...
  public getCharcode_Dach():               number { return this.#CHARCODE__SYMBOL__DACH; }
  public getCharcode_Equality():           number { return this.#CHARCODE__SYMBOL__EQUALITY; }
  public getCharcode_Addition():           number { return this.#CHARCODE__SYMBOL__ADDITION; }

  public getCharcode_Exclamation():        number { return this.#CHARCODE__SYMBOL__EXCLAMATION; }
  public getCharcode_Question():           number { return this.#CHARCODE__SYMBOL__QUESTION; }

  public getCharcode_SymbolBackgroundColor():   number { return this.#CHARCODE__SYMBOL__BACKGROUNDCOLOR_CHAR; }



  public getCharcode_SymbolNumber_0_Zero():   number { return this.#CHARCODE__SYMBOL__NUMBER__0_ZERO; }
  public getCharcode_SymbolNumber_1_One():    number { return this.#CHARCODE__SYMBOL__NUMBER__1_ONE; }
  public getCharcode_SymbolNumber_2_Two():    number { return this.#CHARCODE__SYMBOL__NUMBER__2_TWO; }
  public getCharcode_SymbolNumber_3_Three():  number { return this.#CHARCODE__SYMBOL__NUMBER__3_THREE; }
  public getCharcode_SymbolNumber_4_Four():   number { return this.#CHARCODE__SYMBOL__NUMBER__4_FOUR; }
  public getCharcode_SymbolNumber_5_Five():   number { return this.#CHARCODE__SYMBOL__NUMBER__5_FIVE; }
  public getCharcode_SymbolNumber_6_Six():    number { return this.#CHARCODE__SYMBOL__NUMBER__6_SIX; }
  public getCharcode_SymbolNumber_7_Seven():  number { return this.#CHARCODE__SYMBOL__NUMBER__7_SEVEN; }
  public getCharcode_SymbolNumber_8_Eight():  number { return this.#CHARCODE__SYMBOL__NUMBER__8_EIGHT; }
  public getCharcode_SymbolNumber_9_Nine():   number { return this.#CHARCODE__SYMBOL__NUMBER__9_NINE; }
