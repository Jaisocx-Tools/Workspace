...
export class ResponsiveImports implements ResponsiveImportsInterface {
  ...
  async produceImportsCssFileWithResponsiveFilesSetsSet (
    ...
    let firstLineEncommentedArray: Uint8Array[] = this.responsiveDatasetConstants
    ...
    fileWriterRetVal = await this.produceImportsLinesSet_ForResponsiveFilesSetsSet (
      data,
      bitsbufUrlStart
    );
  ...
  async produceImportsLinesSet_ForResponsiveFilesSetsSet (
    data: any,
    ...
    let paddingBuf: Uint8Array = new Uint8Array(0);
