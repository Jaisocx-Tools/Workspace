...
export declare class ResponsiveImports implements ResponsiveImportsInterface {
    ...
    produceImportsCssFileWithResponsiveCssFilesSet(targetFileName: string, relativeImportedFilesFolderPath: string, importedCssFileWithSizesNames_FileBaseName: string, webpackAliased: boolean, withConstantsImportLine: boolean): Promise<number>;
