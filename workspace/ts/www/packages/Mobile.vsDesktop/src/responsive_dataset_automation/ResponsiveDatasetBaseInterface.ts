...
export interface ResponsiveDatasetBaseInterface {
  ...
  // Mobile.vsDesktop/webpack.aliases.json
  ...
  // for example, workspace/ts/www/packages/Mobile.vsDesktop/MediaAndStyles/responsive
  ...
  // the fest path in this npm package: Mobile.vsDesktop/data/ResponsiveSizes/ResponsiveSizes.json
