...
async function MediaDeviceInfo(): Promise<number> {
  ...
  let pathToJsonDatasetForResponsiveSizes: string = "/var/www/workspace/ts/www/packages/Mobile.vsDesktop/data/ResponsiveSizes/ResponsiveSizes.json";
  let responsiveTemplateFilePath: string = "/var/www/workspace/ts/www/packages/Mobile.vsDesktop/data/templates/ResponsiveTemplate.template";
