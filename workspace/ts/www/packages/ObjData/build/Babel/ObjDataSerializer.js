...
class ObjDataSerializer {
  ...
  static serializeProperty(propName, propValue) {
    ...
    dataHelper.lengthAll = ObjDataConstants_js_1.ObjDataConstants.HEADERS_LENGTH + dataHelper.propertyNameLength + dataHelper.propertyValueLength;
    const headers = ObjDataSerializer.serializePropHeaders(dataHelper);
    return ObjDataPackage_js_1.ObjDataPackage.concatByteArrays([headers, propertyNameSerialized, propertyValueSerialized]);
  }
