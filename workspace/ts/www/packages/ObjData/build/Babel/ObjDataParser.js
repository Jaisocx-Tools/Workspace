...
class ObjDataParser {
  ...
  static parseProperty(objDataByteBuf, offset, dataHelper, parentObject) {
    let retValue = null;
    if (dataHelper.datatype === ObjDataConstants_js_1.ObjDataConstants.DATA_TYPES.ARRAY || dataHelper.datatype === ObjDataConstants_js_1.ObjDataConstants.DATA_TYPES.OBJECT) {
