export interface ScriptsChainedLoaderInterface {
    ...
    loadOneScript(scriptLoaderInstance: ScriptsChainedLoaderInterface, scriptsDataObject: any, npmLibId: number, scriptId: number, hasNext: boolean, isFallback: boolean): void;
...
//# sourceMappingURL=ScriptsChainedLoaderInterface.d.ts.map