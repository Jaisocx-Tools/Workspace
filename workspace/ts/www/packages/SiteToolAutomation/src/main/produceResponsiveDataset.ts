...
async function MediaDeviceInfo(): Promise<number> {
  ...
  let pathToJsonDatasetForResponsiveSizes: string = "/var/www/workspace/ts/www/packages/SiteToolAutomation/data/ResponsiveSizes/ResponsiveSizes.json";
  let responsiveTemplateFilePath: string = "/var/www/workspace/ts/www/packages/SiteToolAutomation/data/templates/ResponsiveTemplate.template";
