export class EmailHtmlInlinerConstants {

  public stylesPropsDefaults: any;
  public tagsStylesDefaults: any;
  public tagsNotZeroPadding: string[];
  public stylesPropsToCheck: string[];
  public inheritingProps: string[];
