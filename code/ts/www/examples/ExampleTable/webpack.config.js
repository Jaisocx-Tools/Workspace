...
const jaisocxTableAliasConfig = require(path.resolve(
  __dirname,
  'node_modules/@jaisocx/table/webpack.aliases.js'
)).default;

console.log(jaisocxTableAliasConfig);
...
export default {
  ...
  resolve: {
    alias: {
      ...jaisocxTableAliasConfig.resolve.alias,
    },
