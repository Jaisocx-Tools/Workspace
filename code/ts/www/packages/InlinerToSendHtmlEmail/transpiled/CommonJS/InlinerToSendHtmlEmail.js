...
exports.InlinerToSendHtmlEmail = void 0;
const text_1 = require("@jaisocx/text");
const css_html_1 = require("@jaisocx/css-html");
const InlinerToSendHtmlEmailConstants_js_1 = require("./InlinerToSendHtmlEmailConstants.js");
class InlinerToSendHtmlEmail {
    constructor() {
        this.debug = true;
        this.constants = new InlinerToSendHtmlEmailConstants_js_1.InlinerToSendHtmlEmailConstants();
    ...
    inline(htmlDocQuerySelector, inStylesPropsToCheck, baseUrlToReplace, baseUrlReplacedWith) {
        ...
        let mainNode = document.querySelector(htmlDocQuerySelector);
        node = mainNode;
        ...
        //   newNodesWithClasses = this.getConcatenatedClassNames( newNodeApplied );
        // }
        this.inlineStyleAllNodes(node, newDoc, newNodeApplied, locInOutInheritedStyles, locInOutArrayRulesMatchingPropsAndMedia, locInOutObjectFilteredRulesAndSpecifitiesByCssPropname, baseUrlToReplace, baseUrlReplacedWith);
        // if ( this.debug === true ) {
        //   newNodesWithClasses = this.getConcatenatedClassNames( newNodeApplied );
        // }
...
exports.InlinerToSendHtmlEmail = InlinerToSendHtmlEmail;
//# sourceMappingURL=InlinerToSendHtmlEmail.js.map