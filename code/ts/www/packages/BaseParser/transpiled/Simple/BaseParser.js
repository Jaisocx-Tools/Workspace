class BaseParser {
  ...
  validBitsbufRefsRefine(
    inBitsbuf, 
    inBitsbufRefs, // datatype explained: [ [startRef: number, endRef: number], [startRef: number, endRef: number], ... ];
    bitsBufRefs_Refined, 
    bitsBufRefs_ofTheTokenType, 
    inTokens, 
    ...
    iteratingInRangesOfRefs: for (inBitsbufId = 0; inBitsbufId < inBitsbufNumber; inBitsbufId++) {
      let inBitsBufRange = inBitsbufRefs[inBitsbufId];
