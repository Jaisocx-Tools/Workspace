...
var _LanguagesCodes_data, _LanguagesCodes_dataAsObject;
Object.defineProperty(exports, "__esModule", { value: true });
exports.LanguagesCodes = void 0;
const JsonWriter_js_1 = require("./JsonWriter.js");
class LanguagesCodes extends JsonWriter_js_1.JsonWriter {
    constructor() {
        super();
        _LanguagesCodes_data.set(this, void 0);
        _LanguagesCodes_dataAsObject.set(this, void 0);
        __classPrivateFieldSet(this, _LanguagesCodes_data, this.initData(), "f");
        __classPrivateFieldSet(this, _LanguagesCodes_dataAsObject, this.initDataAsObject(), "f");
        this.filePath = "";
    }
    ...
    getLanguagesCodes() {
        return __classPrivateFieldGet(this, _LanguagesCodes_data, "f");
    }
    getLanguagesCodesIndexedByLanguageCode() {
        return __classPrivateFieldGet(this, _LanguagesCodes_dataAsObject, "f");
    }
    saveLanguagesCodes(inFilePath) {
        let locSaved = this.saveData(inFilePath, __classPrivateFieldGet(this, _LanguagesCodes_data, "f"));
        return locSaved;
    }
    saveLanguagesCodesIndexedByLanguageCode(inFilePath) {
        let locSaved = this.saveData(inFilePath, __classPrivateFieldGet(this, _LanguagesCodes_dataAsObject, "f"));
        return locSaved;
    }
    initDataAsObject() {
        ...
        let arrayItemId = 0;
        let arrayItem;
        let arrayLen = __classPrivateFieldGet(this, _LanguagesCodes_data, "f").length;
        let countryCode2Chars = "";
        for (arrayItemId = 0; arrayItemId < arrayLen; arrayItemId++) {
            arrayItem = __classPrivateFieldGet(this, _LanguagesCodes_data, "f")[arrayItemId];
...
exports.LanguagesCodes = LanguagesCodes;
_LanguagesCodes_data = new WeakMap(), _LanguagesCodes_dataAsObject = new WeakMap();
