...
# ./genSiteToolTemplate.sh --sitesToolName=SitesToolTemplate --cssOrJsTool=css --template="packages/SitesToolAutomation/data/templates/ResponsiveTemplate.template" --withCssConstantsFile=true --withConstantsImportLine=true
